...
public:
	...
	void setup_object_connection(cl_object_signal, cl_object_handler, cl_base* = nullptr);
	void send_object_signal(cl_object_signal, std::string&);
	void delete_object_connection(cl_object_signal, cl_object_handler, cl_base* = nullptr);
